...
class _EmailPasswordSignInContentsState
  ...
  Future<void> _submit(EmailPasswordSignInState state) async {
    ...
    if (_formKey.currentState!.validate()) {
      final controller = ref.read(
          emailPasswordSingInControllerProvider(widget.formType).notifier);
  ...
  void _updateFormType(EmailPasswordSignInFormType formType) {
    ...
    ref
        .read(emailPasswordSingInControllerProvider(widget.formType).notifier)
  ...
  Widget build(BuildContext context) {
    ref.listen<EmailPasswordSignInState>(
        emailPasswordSingInControllerProvider(widget.formType),
        (_, state) => state.value.showAlertDialogOnError(context));

    final state =
        ref.watch(emailPasswordSingInControllerProvider(widget.formType));
